...
static Key keys[] = {
	...
	{ MODKEY,			XK_grave,	spawn,	SHCMD("dmenuunicode") },
	 { MODKEY|ShiftMask,		XK_j,	togglescratch,	SHCMD("") },
	/* { MODKEY|ShiftMask,		XK_grave,	togglescratch,	SHCMD("") }, */
//	 { ControlMask|ShiftMask,		XK_h,	togglescratch,	SHCMD(TERMINAL" -e htop") },
//	 { ControlMask|ShiftMask,		XK_m,	togglescratch,	SHCMD(TERMINAL" -e mocp") },
//	 { ControlMask|ShiftMask,		XK_k,	togglescratch,	SHCMD("speedcrunch") },
	TAGKEYS(			XK_1,		0)
	TAGKEYS(			XK_2,		1)
	TAGKEYS(			XK_3,		2)
	TAGKEYS(			XK_4,		3)
...
//Y,//	//
	//
	//XK_equal,	spawn,		SHCMD("pamixer --allow-boost -i 5; kill -44 $(pidof dwmblocks)") },
////////////	//{// MODKEY|ShiftMask,		XK_equal,	spawn,		SHCMD("pamixer --allow-boost -i 15; kill -44 $(pidof dwmblocks)") },
//	//////////{ //M//ODKEY,			XK_BackSpace,	spawn,		SHCMD("sysact") },
//	{ //////////MO//D//KEY|ShiftMask,		XK_BackSpace,	spawn,		SHCMD("sysact") },
//////////////
...
//	{ ControlMask|ShiftMask,			XK_m,		spawn,		SHCMD(TERMINAL " -e mocp") },

	{ ControlMask|ShiftMask,			XK_k,		spawn,		SHCMD("speedcrunch") },
	{ ControlMask|ShiftMask,			XK_d,		spawn,		SHCMD("pcmanfm") },
	{ ControlMask|ShiftMask,			XK_v,		spawn,		SHCMD("vlc") },
//	{ MODKEY|ShiftMask,		XK_w,		spawn,		SHCMD(TERMINAL " -e sudo nmtui") },
//	{ MODKEY,			XK_e,		spawn,		SHCMD(TERMINAL " -e neomutt ; pkill -RTMIN+12 dwmblocks; rmdir ~/.abook") },	{ MODKEY|ShiftMask,		XK_e,		spawn,		SHCMD(TERMINAL " -e abook -C ~/.config/abook/abookrc --datafile ~/.config/abook/addressbook") },
